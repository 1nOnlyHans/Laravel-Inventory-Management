            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 items-start">
                ...
                <div class="col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700 text-base">
                        <p><span class="font-semibold text-gray-900">Brand:</span> {{ productDetails.brand.brand_name }}
                        </p>
                        <p><span class="font-semibold text-gray-900">Category:</span> {{
                            productDetails.category.category_name }}</p>
                        <p><span class="font-semibold text-gray-900">Model:</span> {{ productDetails.model }}</p>
                        <p><span class="font-semibold text-gray-900">Supplier:</span> {{
                            productDetails.supplier.supplier_name }}</p>
                    </div>
